export const blogs = [
  {
    ...
    description:
      "You can browse different tags such as multi-page, resume, video, etc. to see more CSS templates.",
    imagePath: "banner-item-01.jpg",
    postedBy: "Admin",
    date: "May 12, 2022",
    noOfComments: 5,
    slug: "/tech",
